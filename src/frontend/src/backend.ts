...
export class Backend implements backendInterface {
    ...
    async getState(): Promise<AppState> {
        if (this.processError) {
            try {
                const result = await this.actor.getState();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async nextScreen(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.nextScreen(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async popBalloon(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.popBalloon(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
